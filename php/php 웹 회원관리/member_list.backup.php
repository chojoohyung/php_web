        ...
        <table class="table table-striped">
            ...
            for ($i=0; $i<count($list); $i++) {
                ...
                <tr>
                    ...
                    <td><?php echo $list[$i]['mb_age'] ?></td>
                    <td><?php echo $list[$i]['mb_phone'] ?></td>
                    <td><?php echo $list[$i]['mb_gender'] ?></td>
                    <td><?php echo $list[$i]['mb_address'] ?></td>
                    <td><?php echo $list[$i]['mb_hobby'] ?></td>
                    <td><?php echo $list[$i]['mb_introduce'] ?></td>
                    <td><?php echo $list[$i]['mb_photo'] ?>
